	...
	<fieldset>
		...
		<table>
			...
			<tr>
				...
				<td><?php echo $form->select('Option.theme', array('default' => 'Default', 'black_edition' => 'Black Edition', 'red_edition' => 'Red Edition'), $themes, array('style' => 'margin-bottom: 0px;', 'empty' => '-- choose a theme --')); ?></td>
			</tr>
		</table>
	</fieldset>
